...
const Circles: React.FC<CirclesProps> = ({
  ...
  return (
    <div className="flex justify-between space-x-4 mt-8 flex-wrap md:flex-nowrap">
      ...
      <div className="flex-1 bg-green-200 rounded-full p-4 text-black font-bold text-center mb-4 md:mb-0">
        <div className="w-20 h-20 rounded-full flex flex-col items-center justify-center">
          <div className="text-3xl">{inProgressRequests}</div>
          <div className="text-sm">In Progress Requests</div>
        </div>
      </div>
      <div className="flex-1 bg-blue-200 rounded-full p-4 text-black font-bold text-center mb-4 md:mb-0">
        <div className="w-20 h-20 rounded-full flex flex-col items-center justify-center">
